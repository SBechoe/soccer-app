    ...
    <form method="post" action="{{route('players.store')}}"
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input type="last-name" name="last_name" id="last-name"
                   class="block py-2.5 px-0 w-full text-black text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                   placeholder=" "/>
            <label for="last-name"
